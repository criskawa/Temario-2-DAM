...
@WebServlet(name = "InsertarSocio", urlPatterns = {"/InsertarSocio"})
public class InsertarSocio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertarSocio</title>");
            ...
            if (gymEJB.insertarSocio(soc)) {
                out.println("Socio dado de alta.");
            } else {
                out.println("Ya existe un socio con ese numero.");
            }
