...
@WebServlet(name = "UpdateMatricula", urlPatterns = {"/UpdateMatricula"})
public class UpdateMatricula extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!gymEJB.existeActividad(tmpA)) {
                out.println("No existe la actividad, no se puede modificar la matricula");
            } else if (!gymEJB.existeSocio(tmpS)) {
                out.println("No existe el socio, no se puede modificar la matricula");
            } else {
                ...
                matri.setSocio(sM);
                if (gymEJB.updateMatricula(matri)) {
                    out.println("Matricula modificada.");
                } else {
                    out.println("No existe una matrícula con ese id.");
                }
            }
